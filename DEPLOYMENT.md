...
11. Backend stores and returns the final enriched result.
```
...
- `chart_pattern_period_results`: 6M/12M classification details
...
- Images are not stored in DB. They are generated by AI server 1 and immediately forwarded to AI server 2.
